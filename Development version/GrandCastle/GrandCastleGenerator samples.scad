...
structure_random_seed = 90;
detail_random_seed = 70;
people_scale = 7;
tall_and_narrow = 7;
dense = 7;
chaos = 6;
...
structure_random_seed = 123;
detail_random_seed = 34;
perimiter_sides = 60;
people_scale = 4;
tall_and_narrow = 2;
dense = 6;
...
structure_random_seed = 3467;
detail_random_seed = 234;
perimiter_sides = 12;
people_scale = 4;
tall_and_narrow = 0;
dense = 5;
...
structure_random_seed = 32424;
detail_random_seed = 36;
perimiter_sides = 4;
people_scale = 4;
tall_and_narrow = 5;
dense = 6;
    ...
    union() {
        ...
        for (i = [0:count_till])
            if (rands(0,1,1,structure_random_seed+i*5)[0] <= probability_of_towers) {
                ...
                /*turret_levels ( current_tower_width, current_tower_height, 
                                current_tower_levels, 0.8, 
                                false, current_tower_sides, 
                                2, current_tower_roof, detail_random_seed+i*100 ) {
                                    for (n = [0:floor( chaos(    
                                    turret_round ( 10, 20, true, 4, 1, 3);
                                        turret_round ( 10, 20, true, 4, 1, 2);
                                }*/
