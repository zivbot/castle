...
random_seed = 50; // [1:1:400]
// Should each corner have a tower?
probability_of_towers = .5; // [0:0.1:1]
// Should a tower have turrets?
probability_of_turrets = 0.7; // [0:0.1:1]
// Maximum number of turrets per tower
max_number_of_turrets = 3;  // [0:1:5]

roof_pointed_ratio = 1.5; // [0.4:0.2:4]


/* [Walls] */
wall_height = 20; // [10:1:140]
wall_diameter = 50; // [20:5:200]
wall_sides = 6; // [4,5,6,8,12,60,0:Random]
wall_thickness = 4; // [4:1:40]

/* [Towers and Turrets] */
// Height (without roof)  (0 = Random)
towers_height = 30;  // [0:1:150]
// Width  (0 = Random)
towers_width = 18; // [0:1:100]
// How many sides/facets for towers
towers_number_of_sides = 8; // [4,5,6,8,12,60,0:Random]
// Towers roof types
towers_roof_type = 3; // [1:Pointed,2:Flat,3:Flat+Point,0:Random]
...
turrets_width_ratio = 0.5; // [0.1:0.1:2]
// Ratio of children turrets to parent (0.1 - very narrow, 0.9 - very wide)
turrets_height_ratio = 0.9; // [0.1:0.1:2]
